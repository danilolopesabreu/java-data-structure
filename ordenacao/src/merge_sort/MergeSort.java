...
public class MergeSort {
	public static void main(String[] args) {
		...
		Aluno[] outrosAlunos = { new Aluno("Jonas", 2), new Aluno("Fernando", 2.3), new Aluno("Ana", 7.1),
				new Aluno("Guilherme", 8), new Aluno("Alberto", 9.2), new Aluno("Maria", 5.25), new Aluno("Paulo", 6),
				new Aluno("Enzo", 7.9), new Aluno("Lucia", 9.8) };
